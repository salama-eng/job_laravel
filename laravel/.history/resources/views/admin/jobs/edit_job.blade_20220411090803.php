...
@endforeach
                ...
                <div class="mb-3 row">
                    ...
                    <div class="col-md-10">
                      <input name="time_start" class="form-control" type="date" value="{{$job->time_start}}" id="html5-date-input" />
                    </div>
                  </div>
                  ...
                  <div class="mb-3 row">
                    ...
                    <div class="col-md-10">
                      <input name="time_close" class="form-control" type="date" value="{{$job->time_close}}" id="html5-date-input" />
                    </div>
                  </div>
