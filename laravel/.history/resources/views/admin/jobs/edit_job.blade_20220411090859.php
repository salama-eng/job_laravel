          ...
          <form method="POST" action="{{ route('update_job',$jobs->id) }}" enctype="multipart/form-data">
            ...
            <div class="row g-3">
                <div class="col-md-6">
                    ...
                    <input value="{{$jobs->jobtitle}}" type="text"name="jobtitle" type="text" id="multicol-username" required class="form-control"
                ...
                <div class="col-md-6">
                    ...
                    <div class="input-group input-group-merge">
                        <input value="{{$jobs->description}}" name="description" type="text" class="form-control" required
                ...
                <div class="col-md-6">
                    ...
                    <div class="input-group input-group-merge">
                        <input value="{{$jobs->country}}" name="country" type="text" class="form-control" required
                            aria-describedby="multicol-email2" />
              ...
              <div class="mb-3 col-md-6">
                <label class="form-label" for="basic-default-country">job type</label>
...
@endforeach
                ...
                <div class="mb-3 row">
                    ...
                    <div class="col-md-10">
                      <input name="time_start" class="form-control" type="date" value="{{$jobs->time_start}}" id="html5-date-input" />
                    </div>
                  </div>
                  ...
                  <div class="mb-3 row">
                    ...
                    <div class="col-md-10">
                      <input name="time_close" class="form-control" type="date" value="{{$jobs->time_close}}" id="html5-date-input" />
                    </div>
                  </div>

                  <div>
                    <label for="exampleFormControlTextarea1" class="form-label">Qualifications</label>
                    <input value="{{$jobs->qualifications}}" name="qualifications" class="form-control" id="exampleFormControlTextarea1" rows="3"></textarea>
                  </div>

                  <div>
                    <label for="exampleFormControlTextarea1" class="form-label">respossbilities</label>
                    <input value="{{$jobs->respossbilities}}" name="respossbilities" class="form-control" id="exampleFormControlTextarea1" rows="3"></textarea>
                  </div>


                  <div>
                    <label for="exampleFormControlTextarea1" class="form-label">steps_to_applye</label>
                    <input value="{{$jobs->steps_to_applye}}" name="steps_to_applye" class="form-control" id="exampleFormControlTextarea1" rows="3"></textarea>
                  </div>
