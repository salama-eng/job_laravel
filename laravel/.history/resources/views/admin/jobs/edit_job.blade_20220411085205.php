...
@endforeach
                ...
                <div class="mb-3 row">
                  ...
                  <div>
                    ...
                    <textarea value="{{$jobs->qualifications}}" name="qualifications" class="form-control" id="exampleFormControlTextarea1" rows="3"></textarea>
                  </div>

                  <div>
                    <label for="exampleFormControlTextarea1" class="form-label">respossbilities</label>
                    <textarea value="{{$jobs->respossbilities}}" name="respossbilities" class="form-control" id="exampleFormControlTextarea1" rows="3"></textarea>
                  </div>
