          ...
          <form method="POST" action="{{ route('update_job',$jobs->id) }}" enctype="multipart/form-data">
            ...
            <div class="row g-3">
                <div class="col-md-6">
                    ...
                    <input value="{{ $jobs->title }}" type="text"name="jobtitle" type="text" id="multicol-username" required class="form-control"
...
@foreach ($jobs->companies as $company )


                        <option value="{{$jobs->companies->id}}">{{$jobs->companies->name}}</option>
@endforeach
