  ...
  <ul class="menu-inner py-1">
    ...
    <li class="menu-item">
      ...
      <ul class="menu-sub">
        ...
        <li class="menu-item">
          <a href="{{ route('create_user') }}" class="menu-link">
    ...
    <li class="menu-item">
      ...
      <ul class="menu-sub">
        <li class="menu-item">
          <a href="{{ url('listjobs') }}" class="menu-link">
            <div data-i18n="List jobs">List jobs</div>
          </a>
        </li>
        <li class="menu-item">
          <a href="addJob" class="menu-link">
    ...
    <li class="menu-item">
      ...
      <ul class="menu-sub">
        <li class="menu-item">
          <a href="{{ url('admin_member') }}" class="menu-link">
            <div data-i18n="list members">list members</div>
          </a>
        </li>
        <li class="menu-item">
    ...
    <li class="menu-item">
      ...
      <ul class="menu-sub">
        <li class="menu-item">
          <a href="{{ url('admin_services') }}" class="menu-link">
      ...
      <ul class="menu-sub">
        <li class="menu-item">
          <a href="{{ url('sliders') }}" class="menu-link">
            <div data-i18n="List slider">List slider</div>
          </a>
        </li>
        <li class="menu-item">
