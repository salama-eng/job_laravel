    ...
    <div class="content-wrapper">
        ...
        <div class="container-xxl flex-grow-1 container-p-y">
            ...
            <div class="card mb-4">
                ...
                <form class="card-body" action="{{ route('storservice') }}"  method="POST" enctype="multipart/form-data" >
                    @csrf
                    <div class="row g-3">
                        <div class="col-md-6">
                            <label class="form-label" for="multicol-username"> title </label>
                            <input name="services_title" type="text" id="multicol-username" required class="form-control"
                        ...
                        <div class="col-md-6">
                          <label class="form-label" for="multicol-email">serice image </label>
                          <div class="input-group input-group-merge">
